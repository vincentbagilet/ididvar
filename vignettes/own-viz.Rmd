...
```{r contrib_bar_plot, echo=TRUE, fig.asp=0.8, message=FALSE}
gapminder_weights |> 
...
```{r idid_contrib_bar_plot, echo=TRUE, fig.asp=0.8, warning=FALSE}
...
data_sf |> 
  ...
  theme_idid() +
  scale_fill_idid() +
  coord_sf(crs = "+proj=ortho +x_0=0 +y_0=0 +lon_0=30 +lat_0=28") +
  labs(
    title = "Distribution of Identifying Variation Weights",
...
idid_viz_weights_map(reg, "l_gdpPercap", world_sf, "iso_alpha") +
  coord_sf(crs = "+proj=ortho +lon_0=30 +lat_0=28") +
  theme(panel.grid.major = element_line(colour = "gray90")) 
```
