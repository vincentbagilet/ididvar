...
It provides a straightforward function to compute identifying variation weights. 
...
The package also allows for an easy exploration of these weights through visualizations.
