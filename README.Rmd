...
pak::pak("vincentbagilet/ididvar")
```
...
The package also allows for an effortless exploration of these weights through visualizations (`idid_viz_weights`, `idid_viz_weights_map`, `idid_viz_cumul`).
