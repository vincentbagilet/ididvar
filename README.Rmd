...
```{r plot_cumul, message=FALSE, fig.asp=1.3, fig.dpi=400, out.width='80%'}
...
idid_viz_contrib(reg_ex_fixest, "sales", var_y = city) +
  ggplot2::labs(y = NULL)
```

The package provides a larger [set of functions](docs/reference/index.html). The [Get started vignette](articles/ididvar.html) introduces them in a concise manner, while also describing a typical workflow for analysis. 
